...
@section('content')
    <main class="main-container">
        ...
        "
            style="padding-top: 35%;padding-left: 20px;padding-right: 20px;">
            <div class="auth-box border-secondary">
                <div id="loginform">
                    <div class="text-center pt-3 pb-3">
                        <span class="db"><img src="{{ asset('/assets/svg/logo.svg') }}" alt="logo" /></span>
                    </div>
                    <form class="form-horizontal mt-3" id="sign_in_form" action="{{ route('admin.authenticate') }}" method="POST">
                        <div class="row">
                            <div class="col-12">
                        ...
                        <div class="row border-top border-secondary">
                            <div class="col-12">
                                <div class="form-group">
                                    <div class="pt-3">
                                        <button class="btn btn-info btn-lg" style="width: 100%" id="to-recover"
                                            type="submit">
                                            Login
                                        </button>
                                    </div>
